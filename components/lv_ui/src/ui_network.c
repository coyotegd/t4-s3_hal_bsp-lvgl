...
void ui_network_create(lv_obj_t * parent) {
    ...
    // Set white text color for all button states (including control keys)
    ...
    lv_obj_set_style_text_color(kb, lv_color_white(), LV_PART_ITEMS); // Fallback for any other state
